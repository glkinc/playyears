export const metadata = {
  title: 'About Us',
  description:
    'Meet Lee and Denoja — the product designers and parents behind Play Years. Learn why we created the First-Year Deck.',
  openGraph: {
    title: 'About Us | Play Years',
        ...
        <div className="flex-container flex-col gap-xl items-center">
          <div className="about-banner-container">
            <div className="about-banner">
              <img src="/images/denoja.svg" alt="" className="denoja" />
              <img src="/images/lee.svg" alt="" className="lee" />
            </div>
          </div>
