export const metadata = {
  title: 'Our Approach',
  description:
    'Research-backed play that fits your day. Play Years™ cards are designed for real life and tired parents.',
  openGraph: {
    title: 'Our Approach | Play Years',
      ...
      <div className="content">
        <div className="flex-container flex-col gap-xl items-center">
          ...
          <div className="col-lg-10">
            <img src="/images/approach-image.jpg" alt="Father playing with son" style={{ width: '100%' }} />
          </div>
