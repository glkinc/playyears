export const metadata = {
  ...
  description:
    'Become a Play Years Ambassador. Share your love of play with families and earn exclusive perks.',
  openGraph: {
    title: 'Ambassador Program | Play Years',
        ...
        <div className="flex-container flex-col gap-xl items-start">
          ...
          <div className="narrow">
            <div className="flex-container flex-col gap-md">
              ...
              <div className="padding-all-md radius-md bg-secondary">
                <div className="flex-container flex-col gap-md">
                  <div className="flex-container flex-col gap-xxs">
