...
import { Baby, Heart, Smile, ListCheck, Truck } from "lucide-react";
...
const ShopContent = () => {
  ...
  const productImages = [
    '/images/product-shot.jpg',
    '/images/product-shot-alt.jpg',
    '/images/product-shot-alt-2.jpg',
    '/images/product-shot-alt-3.jpg',
  ]
  ...
  useEffect(() => {
    ...
    if (width <= 800) settings = { ...settings, slidesToShow: 1, slidesToScroll: 1 }
              ...
              <div className="flex-container flex-col gap-sm">
                <div className="flex-container flex-col gap-xs padding-top-xl shop-title">
                  <h1 className="heading heading-xl">
                    Play Years<sup>&trade;</sup><br />First-Year Deck
                  </h1>
                </div>
                ...
                <p><strong>Why Parents Love Play Years<sup>&trade;</sup></strong></p>
                <Accordion
                  items={[
                    {
                      icon: <Baby size={18} />,
                      label: 'Developmental Benefits',
                      content: 'Each card is designed with input from early childhood experts to support sensory, cognitive, and motor growth.',
                    },
                    {
                      icon: <Heart size={18} />,
                      label: 'Parent-Child Bonding',
                      content: 'Every activity promotes meaningful connection and responsiveness between you and your baby.',
                    },
                    {
                      icon: <Smile size={18} />,
                      label: 'Age-Appropriate Play',
                      content: "Cards are organized by age range to make it easy to find activities suited for your baby's current stage.",
                    },
                  ]}
                />
              </div>
                ...
                <div className="grid grid-lg-4 grid-md-4 grid-sm-4 grid-xs-4 gap-sm">
                  {productImages.map((img, i) => (
                    <img
                      ...
                      alt={`Thumbnail ${i + 1}`}
                      style={{ width: '100%' }}
                      className={`radius-sm thumb ${mainImage === img ? 'active' : ''}`}
                      onMouseEnter={() => { setMainImage(img); setLightboxIndex(i) }}
                    />
                  ))}
                </div>
                <Lightbox
      ...
      <section className="padding-top-2xl padding-bottom-2xl bg-secondary">
        <div className="content">
          <div className="flex-container flex-col gap-xxs">
            <span className="body-lg weight-500 text-highlight-secondary">Details</span>
              ...
              <div className="flex-container flex-col gap-sm">
                <div className="flex-container flex-col gap-sm radius-md padding-all-lg bg-primary">
                  ...
                  <ul className="bullets text-lg">
                    ...
                    <li><strong>Packaging:</strong> Sturdy matte box designed for everyday use &amp; storage</li>
                  </ul>
                </div>
                ...
                <div className="flex-container flex-col gap-sm radius-md padding-all-lg bg-primary">
                  ...
                  <ul className="bullets text-lg">
                    <li>
                      Fast, Reliable Shipping: Fulfilled by Amazon for quick
                      delivery straight to your door.
                    </li>
                    <li>
                      Free Returns: Eligible for Amazon’s 30-day free returns.
                    </li>
                  </ul>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="flex-container flex-col gap-sm">
                <div className="flex-container flex-col gap-sm radius-md padding-all-lg bg-primary">
                  ...
                  <p>Choose a card each day to explore a new play activity, using common household items and simple routines.</p>
                </div>
                <div className="flex-container flex-col gap-sm radius-md padding-all-lg bg-primary">
                  <div className="flex-container flex-row gap-xs items-center">
                    <img src="/images/ico-maple-leaf.svg" alt="" style={{ width: 24 }} />
                ...
                <div className="flex-container flex-row justify-end">
                  <img src="/images/bento-dog.svg" alt="" className="details-dog" />
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className="testimonial">
                    <div className="flex-container items-start wrap-sm wrap-xs flex-row gap-sm">
                      <div className="flex-container items-center flex-row gap-xs">
                        <img src={review.image} alt="" style={{ maxWidth: '6.4rem' }} />
                      </div>
                      <blockquote className="body-md">{review.text}</blockquote>
                    </div>
                  </div>
                </div>
              ))}
