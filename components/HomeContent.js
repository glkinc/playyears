...
const HomeContent = () => {
  ...
  useEffect(() => {
    ...
    if (width <= 768) settings = { ...settings, centerPadding: '16px' }
    else if (width <= 1024) settings = { ...settings, centerPadding: '24px' }
            ...
            <div className="col col-lg-5 col-sm-12 col-xs-12">
              <div className="flex-container flex-col gap-sm">
                <div className="flex-container flex-col gap-xxs">
                  <span className="body-lg weight-500 text-highlight-primary">50 Activity Cards</span>
                  <h1 className="heading heading-xl">Play ideas for development &amp; bonding.</h1>
                </div>
                <div className="flex-container flex-col gap-md wrap-sm wrap-xs">
                  ...
                  <div className="flex-container flex-row gap-sm">
                    <a href="https://amazon.ca/dp/B0H2XFJKGG" target="_blank" rel="noreferrer" className="btn">Buy Now on Amazon</a>
      ...
      <main className="main padding-top-xl padding-bottom-3xl">
        <div className="content">
          <div className="flex-container flex-col gap-sm col-lg-6">
            <div className="flex-container flex-col gap-xxs">
              <span className="body-lg weight-500 text-highlight-secondary">One Deck.</span>
              <h2 className="heading heading-xl">A Full Year of Milestones.</h2>
            </div>
            <p className="body-lg">At Play Years&trade;, we believe play is more than just fun. It's how your baby starts to learn, grow, and connect.</p>
          </div>
          ...
          <div className="bento">
            <div className="item-1">
              <div className="flex-container flex-col gap-sm">
                <span className="heading heading-lg">Your baby's first year is full of growth.</span>
                <p className="body-lg">Your baby's brain makes over a million new connections every second. The way you play together now shapes what comes next.</p>
                <button className="btn btn-secondary" onClick={() => setShowModal(true)}>Join Mailing List</button>
              </div>
            </div>
            <div className="item-2">
              <div className="flex-container flex-col gap-sm">
                <span className="heading heading-lg">Support for Five Key Development Areas</span>
                <p className="body-lg">Each activity supports one or more core areas of your baby's growth.</p>
              </div>
              <img src="/images/bento-cards.png" alt="Play Year Cards" />
            </div>
            <div className="item-3">
              <div className="flex-container flex-row gap-sm">
                <img src="/images/bento-elephant.svg" alt="" />
                <span className="heading heading-md">Help your baby learn through play</span>
              </div>
            </div>
            <div className="item-4">
              <div className="flex-container flex-col gap-xxs text-align-center justify-center full-height">
                ...
                <span className="heading heading-lg text-highlight-primary">Families</span>
              </div>
            </div>
            <div className="item-5">
              <div className="flex-container flex-col gap-xxs text-align-center justify-center full-height">
                <span className="heading heading-sm text-highlight-tertiary">For babies</span>
                <span className="heading heading-lg">0–12<br />Months</span>
              </div>
            </div>
            <div className="item-6">
              <div className="flex-container flex-col gap-sm text-align-center">
                <img src="/images/bento-50.svg" alt="50" className="bento-50" />
                <span className="body-lg">Play ideas that support development and connection every day!</span>
                <img src="/images/bento-dog.svg" alt="" className="bento-dog" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="columns justify-center">
            <div className="col col-lg-6">
              <div className="flex-container flex-col gap-xxs text-align-center">
                <h2 className="heading heading-xl">What our professionals say about Play Years&trade;</h2>
              </div>
            </div>
          </div>
        </div>
          ...
          <Slider ref={sliderRef} {...sliderSettings}>
            {quotes.map((quote, i) => (
              <div key={i} className="slide">
                <div className={`testimonial ${['pink', 'yellow', 'blue'][i % 3]}`}>
                  <blockquote className="body-xl">"{quote}"</blockquote>
                </div>
              </div>
            ))}
          </Slider>
          ...
          <div className="columns wrap-sm wrap-xs justify-between">
            <div className="col col-lg-4 col-md-6 col-sm-12 col-xs-12 sticky">
              <div className="flex-container flex-col gap-xs">
                ...
                <div className="flex-container flex-col gap-sm">
                  <p className="body-lg">The Play Years&trade; First-Year deck includes 50 research-backed activities that support your baby's development and strengthen your bond, one playful moment at a time.</p>
                  <p className="body-lg">Each card is organized by skill, helping you understand how simple play supports language, motor, cognitive, sensory, and social-emotional development.</p>
            ...
            <div className="col col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div className="flex-container flex-col gap-md">
                <div data-aos="fade-up" className="flex-container flex-row gap-md items-center padding-top-md padding-bottom-md padding-left-lg padding-right-lg radius-md text-invert bg-galaxy-blue">
                  <img src="/images/octopus.png" alt="Sensory" style={{ width: '12rem' }} />
                  <div className="flex-container flex-col gap-xs">
                ...
                <div data-aos="fade-up" className="flex-container flex-row gap-md items-center padding-top-md padding-bottom-md padding-left-lg padding-right-lg radius-md text-invert bg-moon-dust">
                  <img src="/images/parrot.png" alt="Speech and Language" style={{ width: '12rem' }} />
                  <div className="flex-container flex-col gap-xs">
                ...
                <div data-aos="fade-up" className="flex-container flex-row gap-md items-center padding-top-md padding-bottom-md padding-left-lg padding-right-lg radius-md text-invert bg-cosmic-pink">
                  <img src="/images/elephant.png" alt="Physical and Gross Motor" style={{ width: '12rem' }} />
                  <div className="flex-container flex-col gap-xs">
                ...
                <div data-aos="fade-up" className="flex-container flex-row gap-md items-center padding-top-md padding-bottom-md padding-left-lg padding-right-lg radius-md text-primary bg-solar-yellow">
                  <img src="/images/raccoon.png" alt="Fine Motor" style={{ width: '12rem' }} />
                  <div className="flex-container flex-col gap-xs">
                ...
                <div data-aos="fade-up" className="flex-container flex-row gap-md items-center padding-top-md padding-bottom-md padding-left-lg padding-right-lg radius-md bg-grass-green text-invert">
                  <img src="/images/dog.png" alt="Social-Emotional" style={{ width: '12rem' }} />
                  <div className="flex-container flex-col gap-xs">
                ...
                <div data-aos="fade-up" className="flex-container flex-row gap-md items-center padding-top-md padding-bottom-md padding-left-lg padding-right-lg radius-md text-invert bg-true-blue">
                  <img src="/images/dolphin.png" alt="Cognitive" style={{ width: '12rem' }} />
                  <div className="flex-container flex-col gap-xs">
          ...
          <div className="columns gap-none wrap-sm wrap-xs radius-md">
            <div className="col col-lg-6">
              <div className="flex-container flex-row items-center justify-center padding-all-md full-height bg-solar-yellow">
                <img src="/images/card-anatomy.png" alt="Tagged by development skill, Compact Storage Box, Easy-to-Follow Instructions, Why it matters - understanding what baby is learning" className="card-anatomy" data-aos="zoom-in" />
              </div>
            </div>
            <div className="col col-lg-6">
              <div className="flex-container flex-col gap-md padding-all-xl full-height bg-primary">
                ...
                <a href="https://amazon.ca/dp/B0H2XFJKGG" className="btn" target='_blank' rel="noreferrer">Get Play Years on Amazon</a>
              </div>
            </div>
          </div>
        </div>
